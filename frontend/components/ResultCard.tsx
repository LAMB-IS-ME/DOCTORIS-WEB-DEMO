        ...
        <div className="grid grid-cols-1 md:grid-cols-1 gap-8">
          {data.sections.map((section, index) => (
            <div key={index} className="border-b border-slate-100 last:border-0 pb-6 last:pb-0">
              ...
              <div className="text-slate-700 leading-relaxed pl-11 prose prose-slate max-w-none">
                <ReactMarkdown
                  ...
                  components={{
                    ...
                    blockquote: ({node, ...props}) => (
                      <blockquote className="border-l-4 border-medical-400 pl-4 italic text-slate-600 my-3" {...props} />
                    ),
